...
export class SessionExportService {
  ...
  private getFieldMapping(): Record<string, {
    ...
    return {
      ...
      planIfa250: { label: 'Plan - IFA 250ml', getter: (s) => s.therapyPlan?.ifa250 ?? '-' },
      planIfa500: { label: 'Plan - IFA 500ml', getter: (s) => s.therapyPlan?.ifa500 ?? '-' },
      planHho: { label: 'Plan - HHO', getter: (s) => s.therapyPlan?.hho ?? '-' },
      planHhoKonsentrat: { label: 'Plan - HHO Konsentrat', getter: (s) => s.therapyPlan?.hhoKonsentrat ?? '-' },
      ...
      aktualIfa250: { label: 'Aktual - IFA 250ml', getter: (s) => s.infusion?.ifa250 ?? '-' },
      aktualIfa500: { label: 'Aktual - IFA 500ml', getter: (s) => s.infusion?.ifa500 ?? '-' },
      aktualHho: { label: 'Aktual - HHO', getter: (s) => s.infusion?.hho ?? '-' },
      aktualHhoKonsentrat: { label: 'Aktual - HHO Konsentrat', getter: (s) => s.infusion?.hhoKonsentrat ?? '-' },
  ...
  async exportSessions(
    ...
    const fieldOrder = [
      ...
      'planIfa250', 'planIfa500', 'planHho', 'planHhoKonsentrat', 'planH2', 'planNo', 'planGaso', 'planO2', 'planO3', 'planEdta', 'planMb', 'planH2s', 'planKcl', 'planJmlNb', 'planKeterangan',
      'aktualIfa250', 'aktualIfa500', 'aktualHho', 'aktualHhoKonsentrat', 'aktualH2', 'aktualNo', 'aktualGaso', 'aktualO2', 'aktualO3', 'aktualEdta', 'aktualMb', 'aktualH2s', 'aktualKcl', 'aktualJmlNb', 'bottleType', 'jenisCairan', 'volumeCarrier', 'jumlahJarum', 'deviationNotes',
      'materialsSummary',
