      ...
      sessions.map(async (session) => {
        ...
        return {
          session: {
            ...
            diagnosisDeferred: session.diagnosisDeferred,
            completionStatus: session.completionStatus,
            completedAt: session.completedAt?.toISOString() ?? null,
            recognizedRevenue: session.recognizedRevenue.toFixed(2),
            materialCost: session.materialCost.toFixed(2),
            grossProfit: session.grossProfit.toFixed(2),
