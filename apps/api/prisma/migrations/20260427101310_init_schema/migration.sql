...
-- CreateEnum
CREATE TYPE "BranchType" AS ENUM ('KLINIK', 'HOMECARE', 'PREMIERE', 'PARTNERSHIP');
...
-- CreateEnum
CREATE TYPE "BoosterType" AS ENUM ('NO', 'GT', 'MB', 'KCL', 'H2S', 'HK', 'O3', 'HHO', 'NO2');
...
-- CreateTable
CREATE TABLE "master_booster_types" (
    "id" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "icon" TEXT,
    ...
    CONSTRAINT "master_booster_types_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "master_service_types" (
    ...
    CONSTRAINT "master_service_types_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "master_booster_types_code_key" ON "master_booster_types"("code");

-- CreateIndex
CREATE INDEX "master_booster_types_isActive_idx" ON "master_booster_types"("isActive");

-- CreateIndex
CREATE INDEX "master_booster_types_sortOrder_idx" ON "master_booster_types"("sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "master_service_types_code_key" ON "master_service_types"("code");

-- CreateIndex
CREATE INDEX "master_service_types_isActive_idx" ON "master_service_types"("isActive");

-- CreateIndex
CREATE INDEX "master_service_types_sortOrder_idx" ON "master_service_types"("sortOrder");
...
-- CreateIndex
CREATE UNIQUE INDEX "package_pricings_branchId_packageType_boosterType_serviceTy_key" ON "package_pricings"("branchId", "packageType", "boosterType", "serviceType", "totalSessions");
...
-- CreateIndex
CREATE INDEX "member_packages_paymentProofUrl_idx" ON "member_packages"("paymentProofUrl");
...
-- CreateIndex
CREATE INDEX "member_add_ons_paymentProofUrl_idx" ON "member_add_ons"("paymentProofUrl");
...
-- CreateIndex
CREATE INDEX "member_non_therapy_purchases_paymentProofUrl_idx" ON "member_non_therapy_purchases"("paymentProofUrl");
...
-- CreateIndex
CREATE INDEX "invoice_payments_proofFileUrl_idx" ON "invoice_payments"("proofFileUrl");
...
-- CreateIndex
CREATE INDEX "master_products_base_unit_usage_unit_idx" ON "master_products"("base_unit", "usage_unit");
