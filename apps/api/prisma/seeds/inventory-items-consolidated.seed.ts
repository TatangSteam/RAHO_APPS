...
export async function seedConsolidatedInventoryItems(prisma: PrismaClient) {
  ...
  console.log('🔄 ATURAN: Sesuai List Barang RAHO Official\n');
  ...
  const masterProducts = [
    ...
    { sku: 'PRD-NBT-CNO-001', name: 'NB NO', category: ProductCategory.MEDICINE, baseUnit: 'ml', usageUnit: 'ml', conversionFactor: 1, description: 'Nano Bubble Nitric Oxide - untuk field: no', stock: 3000, minStock: 500 },
    ...
    { sku: 'PRD-NBT-CO2-001', name: 'O2 (Oxygen)', category: ProductCategory.MEDICINE, baseUnit: 'ml', usageUnit: 'ml', conversionFactor: 1, description: 'Oxygen - untuk field: o2', stock: 15000, minStock: 3000 },
    ...
    { sku: 'PRD-NBT-EDT-001', name: 'EDTA', category: ProductCategory.MEDICINE, baseUnit: 'ml', usageUnit: 'ml', conversionFactor: 1, description: 'EDTA - untuk field: edta', stock: 5000, minStock: 1000 },
    ...
    { sku: 'PRD-MED-HDS-001', name: 'Handscoon S', category: ProductCategory.CONSUMABLE, baseUnit: 'Piece', usageUnit: 'Piece', conversionFactor: 1, description: 'Sarung tangan medis ukuran S', stock: 1000, minStock: 200 },
    { sku: 'PRD-MED-HDS-002', name: 'Handscoon M', category: ProductCategory.CONSUMABLE, baseUnit: 'Piece', usageUnit: 'Piece', conversionFactor: 1, description: 'Sarung tangan medis ukuran M', stock: 1000, minStock: 200 },
