...
type IncentiveView = 'all' | 'nakes' | 'mso';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">
                {view === 'nakes' ? 'Insentif Nakes' : view === 'mso' ? 'Insentif MSO' : 'Insentif Nakes & MSO'}
              </h1>
              <p className="text-sm text-neutral-500 dark:text-neutral-400">
                {view === 'nakes'
                  ...
                  : view === 'mso'
                    ...
                    : 'Perhitungan bulanan berdasarkan sesi selesai dan penjualan Air Nano lunas.'}
              </p>
            </div>
          </div>
        ...
        {loading && !data ? (
          ...
          <>
            <section className="grid gap-4 md:grid-cols-3">
              {[
                ...(view !== 'mso' ? [{ label: 'Total Nakes', value: data.summary.nakesTotalAmount, detail: `${data.summary.nakesRecipients} penerima`, icon: Droplets, tone: 'text-emerald-500' }] : []),
                ...(view !== 'nakes' ? [{ label: 'Total MSO', value: data.summary.msoTotalAmount, detail: `${data.summary.msoRecipients} penerima`, icon: Users, tone: 'text-blue-500' }] : []),
            ...
            {view !== 'mso' && <section className="rounded-2xl border border-emerald-200 bg-white dark:border-emerald-500/20 dark:bg-neutral-900">
            ...
            {view !== 'nakes' && <section className="rounded-2xl border border-blue-200 bg-white dark:border-blue-500/20 dark:bg-neutral-900">
              ...
              <p>
                {view === 'nakes'
                  ...
                  : view === 'mso'
                    ...
                    : 'Bonus target Nakes dan bonus visit MSO dibayar satu kali per bulan dan tidak berlaku kelipatan.'}{' '}
