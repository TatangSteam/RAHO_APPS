...
import { X, Plus, Check, RefreshCw, Trash2, Package, Search, Filter } from 'lucide-react';
                  ...
                  <div className="p-3 space-y-3">
                    {requestItems.map((item) => (
                      <div
                        ...
                        className="p-4 rounded-xl bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 shadow-sm"
                      >
