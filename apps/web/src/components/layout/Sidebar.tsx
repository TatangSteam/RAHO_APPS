  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        roles: ['SUPER_ADMIN', 'ADMIN_MANAGER', 'FINANCE_LOGISTICS_CONTROLLER', 'ADMIN_CABANG', 'ADMIN_LAYANAN', 'DOCTOR', 'NURSE'],
      },
      {
        label: 'Purchasing & AP',
        href: '/purchasing',
      ...
      },
      {
        ...
        href: '/approvals',
        icon: <ListChecks size={20} />,
        roles: ['SUPER_ADMIN', 'ADMIN_MANAGER', 'ADMIN_CABANG', 'ADMIN_LOGISTIK', 'FINANCE_LOGISTICS_CONTROLLER'],
      },
    ],
  },
  {
